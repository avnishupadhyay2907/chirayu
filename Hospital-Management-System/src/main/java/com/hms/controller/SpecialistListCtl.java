...
@WebServlet(name = "SpecialistListCtl", urlPatterns = { "/ctl/SpecialistListCtl" })
public class SpecialistListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(DoctorListCtl.class);

	protected BaseDTO populateDTO(HttpServletRequest request) {
		System.out.println("Specialist List =====>" + "populate dto method started");
		...
		System.out.println("Specialist List =====>" + "populate dto method ended");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Specialist List ====>" + "do get start");
		...
		log.debug("Specialist list do get end");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws IOException, ServletException {
		System.out.println("Specialist List ====>" + "do post start");
		log.debug("Specialist do post start");
		List list;
		...
		try {
			if (OP_SEARCH.equalsIgnoreCase(op) || "next".equalsIgnoreCase(op) || "previous".equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					SpecialistDTO deletebean = new SpecialistDTO();
					for (String id : ids) {
		...
		log.debug("Specialist list do post end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return ORSView.SPECIALIST_LIST_VIEW;
	}
