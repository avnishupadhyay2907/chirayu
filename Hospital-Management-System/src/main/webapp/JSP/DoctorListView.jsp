...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/image/doctorList.jpg');
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.DOCTOR_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="com.hms.dto.DoctorDTO" scope="request"></jsp:useBean>
				...
				<table class="table table-dark table-bordered table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th class="text">Specialist Department</th>
							<th class="text">Phone No</th>
							<th class="text">EmailId</th>
					...
					<tbody>
						<tr>
							...
							<td align="center"><%=dto.getSpecialistName()%></td>
