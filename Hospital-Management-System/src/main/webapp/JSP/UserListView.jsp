...
<%@page import="com.hms.controller.UserListCtl"%>
<%@page import="com.hms.util.HTMLUtility"%>
<%@page import="com.hms.model.ModelFactory"%>
<%@page import="com.hms.model.RoleModelInt"%>
...
<style>
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/image/userList.jpeg');
...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.USER_LIST_CTL%>" method="post">
			<jsp:useBean id="dto" class="com.hms.dto.UserDTO" scope="request"></jsp:useBean>
			<%
